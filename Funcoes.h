...
#include "dataValida.h" //para validar a data
#include "horaValida.h" //para validar a hora

#define MAX_PASSAGENS 100   //ja define o maximo de passagens a serem cadastradas
...
int ultimo_Id = 0;                         // inicia o ultimo ID
...
void pesquisarPassagem()
{
    ...
    for (int i = 0; i < total_Passagens; i++)
    {
        ...
        case 1:
            ...
            break;
        case 2:
            if (strcmp(chave, passagens[i].aero_Origem) == 0) 
            {
                encontrado = 1;
            }
            break;
        ...
        case 5:
            ...
            break;
        default:
            printf("Opcao de pesquisa invalida.\n");
            return;
        }
...
void cadastrarPassagem()
{
    if (total_Passagens < MAX_PASSAGENS)
    {
        ...
        do
        {
            ...
            if (strlen(P.aero_Origem) != 3)
            {
                printf("\nAeroporto de origem invalido!\n");
            }
        } while (strlen(P.aero_Origem) != 3); // Testa se sao 3 caracteres

        do
        {
            printf("Digite o aeroporto de destino: ");
            scanf(" %s", P.aero_Destino);
            if (strlen(P.aero_Destino) != 3)
            {
                printf("\nAeroporto de destino invalido\n!");
            }
        } while (strlen(P.aero_Destino) != 3);
